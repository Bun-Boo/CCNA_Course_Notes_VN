# 12. VÒNG ĐỜI CỦA MỘT GÓI TIN (LIFE OF A PACKET)

![image](https://github.com/psaumur/CCNA/assets/106411237/ec16b9fd-4d90-4b73-b930-cd825ff13b00)


Mỗi giao diện của thiết bị mạng đều có một ĐỊA CHỈ MAC DUY NHẤT.

Trong một tiêu đề TCP (TCP HEADER):

ĐỊA CHỈ IP NGUỒN đứng trước ĐỊA CHỈ IP ĐÍCH.

Trong khi đó...

Trong một tiêu đề ETHERNET (ETHERNET HEADER):

ĐỊA CHỈ MAC ĐÍCH đứng trước ĐỊA CHỈ MAC NGUỒN.
...
![image](https://github.com/psaumur/CCNA/assets/106411237/91cfe407-28 b5-48e8-b5f8-a60b324e0706)
...
Khi một HOST gửi một gói tin đến một HOST khác, ĐỊA CHỈ IP NGUỒN hoặc IP ĐÍCH sẽ không thay đổi - mặc dù các ROUTER có thể thay đổi TIÊU ĐỀ ETHERNET (địa chỉ MAC NGUỒN/ĐÍCH).
