# 11. ĐỊNH TUYẾN TĨNH : PHẦN 2

ÔN TẬP:

SWITCH chuyển tiếp lưu lượng TRONG phạm vi mạng LAN.
ROUTER chuyển tiếp lưu lượng GIỮA các mạng LAN.

WAN (Wide Area Network - Mạng diện rộng)

- Mạng lưới trải rộng trên một khu vực lớn.
...
TUYẾN ĐƯỜNG TĨNH (STATIC ROUTES):
...
Cấu hình TUYẾN ĐƯỜNG TĨNH với *giao diện thoát (exit-interface)*:
